...
class Network(nn.Module):
    def __init__(self, classes=1000):
        ...
        self.conv.add_module(
            "conv1_s1", nn.Conv2d(3, 96, kernel_size=11, stride=2, padding=0)
        )
        ...
        self.conv.add_module(
            "conv4_s1", nn.Conv2d(384, 384, kernel_size=3, padding=1, groups=2)
        )
        self.conv.add_module("relu4_s1", nn.ReLU(inplace=True))

        self.conv.add_module(
            "conv5_s1", nn.Conv2d(384, 256, kernel_size=3, padding=1, groups=2)
        )
