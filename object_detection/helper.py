...
def compute_ats_bounding_boxes(boxes1, boxes2):  #N x 2 x 4 
    #print(boxes1)
    #print(boxes2)
    #print(boxes1.shape)
    #print(boxes2.shape)
    ...
    #For each predicted object, take min/max x and y value
    ...
    #For predicted and true, create a N1 x N2 boolean tensor showing cases where predicted is larger/smaller than true
    condition1_matrix = (boxes1_max_x.unsqueeze(1) > boxes2_min_x.unsqueeze(0))
    #print(condition1_matrix)
    condition2_matrix = (boxes1_min_x.unsqueeze(1) < boxes2_max_x.unsqueeze(0))
    condition3_matrix = (boxes1_max_y.unsqueeze(1) > boxes2_min_y.unsqueeze(0))
    condition4_matrix = (boxes1_min_y.unsqueeze(1) < boxes2_max_y.unsqueeze(0))
    
    #Collect all 4 and find cases where all are true. 
